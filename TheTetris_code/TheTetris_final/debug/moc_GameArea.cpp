...
void GameArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameArea::sigUpdateNextBlock)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (GameArea::*_t)(Block * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameArea::sigUpdateHoldBlock)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameArea::sigUpdateScore)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (GameArea::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameArea::sigUpdateSpeed)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject GameArea::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GameArea.data,
      qt_meta_data_GameArea,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
